...
{   		
    ...
    private static $bdd='dbname=la_fleur';   		
...
*/
    ...
    public function setPrixProduit($idProduit, $prixProduit)
    {
        $req="update produit SET prix = $prixProduit where id = '$idProduit'";
    ...
    /*public function setNewProduit()
    {
        $req = "INSERT INTO produit (description, prix, image, idCategorie) VALUES ($desc_prod, $prix_prod, $img_prod, $id)" ;
    }*/
...
*/
    ...
    public function getConnect($login, $mdp){

		$req = "select administrateur.id as id, administrateur.nom as nom from administrateur 
		where administrateur.nom='$login' and administrateur.mdp='$mdp'";
		$rs = PdoLafleur::$monPdo->query($req);
		$ligne = $rs->fetch();      // fetch : parcours les lignes
		return $ligne;
	}
